...
def _plot_co2_temp(df, ax):
    df = df.tail(10)
    ax.clear()
    sns.lineplot(data=df, x='time', y='co2', marker='o', color='orange', ax=ax, label='co2')
    ax.set_xlabel('')
    ax.set_ylabel('CO2')
...
def _plot_temp_nh4(df, ax):
    ...
    ax.clear()
    sns.lineplot(data=df, x='time', y='temperature', marker='o', ax=ax, label='Temperature')
    sns.lineplot(data=df, x='time', y='humidity', marker='o', ax=ax, label='Humidity', color='black')
    ax.set_xlabel('')
